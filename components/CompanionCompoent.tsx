...
const CompanionCompoent = ({companionId, subject, topic, name, userName, userImage, style, voice}: CompanionComponentProps) => {
            ...
            <section className="flex gap-8 max-sm:flex-col">
                ...
                <div className="user-section">
                    ...
                    onClick={callStatus === CallStatus.ACTIVE ? handleDisconnect : handleCall}>
                        {callStatus === CallStatus.ACTIVE ? "End Session" : callStatus === CallStatus.CONNECTING ? 'Connecing'
                        : 'Start Session'}
                    </button>
                </div>
            </section>
...
export default CompanionCompoent;